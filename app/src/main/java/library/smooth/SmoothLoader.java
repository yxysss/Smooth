...
public class SmoothLoader {
    ...
    private String getFilename(String fileurl) {
        ...
        filename.append(hashKeyForDisk(fileurl));
    ...
    public String getFinishFilename(String fileurl) {
        StringBuilder finishfilename = new StringBuilder();
        finishfilename.append("over");
        finishfilename.append(getFilename(fileurl));
        return getCacheDir(finishfilename.toString());
    }
